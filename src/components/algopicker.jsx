...
const ALGOS = [
    ["combo_basic", "ComboBasic", 
        <>
            ComboBasic is an extension of the Basic algorithm, designed by <Link href="https://arxiv.org/abs/1611.07804">Astrakhantsev (2016)</Link>, which calculates the termhood of a candidate term <i>t</i> by a weighted average of the number of times <i>t</i> contains another candidate, the number of times another term contains <i>t</i>, and the length of <i>t</i> in characters times the log of the frequency of <i>t</i>. <Link href="https://kevinlu1248.github.io/pyate/algorithms.html#combobasic">More info</Link>
        </>
    ],
    ["basic", "Basic", 
        <>
            The Basic algorithm was designed by <Link href="https://arxiv.org/abs/1611.07804">Astrakhantsev (2016)</Link>, which calculates the termhood of a candidate term <i>t</i> by a weighted average of the number of times another term contains <i>t</i>, and the length of <i>t</i> in characters times the log of the frequency of <i>t</i>. <Link href="https://kevinlu1248.github.io/pyate/algorithms.html#basic">More info</Link>
        </>
    ], 
    ["cvalues", "C-Values", 
        <>
            The C-Value algorithm was designed by <Link href="https://www.researchgate.net/publication/220387502_Automatic_Recognition_of_Multi-word_Terms_The_C-value_NC-value_Method">Frantzi, Ananiado and Mima (2000)</Link>, which calculates the termhood of a term <i>t</i> by taking the log of words in <i>t</i> times the frequency of <i>t</i> subtracted by the mean of the termhoods of every candidate containing <i>t</i>. <Link href="https://kevinlu1248.github.io/pyate/algorithms.html#cvalues">More info</Link>
        </>
    ],
